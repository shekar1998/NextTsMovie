...
import { AllMovies } from '../api/hello';
...
export default function FullWidthGrid() {
  ...
  const movies: any = DUMMY_EVENTS;
  // let className1: any = 'card-side card_front_side-default';
  // let className2: any = 'card-side card_back_side-default';

  const RotateAll = (id: any) => {
    setid(id);
  };
      ...
      <div className='row container'>
        {movies ? (
          movies.map((val: any) => {
            ...
            let rating: any = val.vote_average * 10;
            let circleColor: any;
            if (rating <= 25) {
              circleColor = 'red';
