...
class App extends Component {
  ...
  addSeatCallback = ({ row, number, id }: any, addCb: any) => {
    this.setState(
      {
        loading: true,
      },
  ...
  addSeatCallbackContinousCase = ({ row, number, id }: any, addCb: any, params: any, removeCb: any) => {
    this.setState(
      {
        loading: true,
      },
  ...
  removeSeatCallback = ({ row, number, id }: any, removeCb: any) => {
    this.setState(
      {
        loading: true,
      },
